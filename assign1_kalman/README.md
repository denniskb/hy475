...
Please submit your **[base64-encoded](https://www.utilities-online.info/base64)** *source code* **by Mar 18** to denniskb(at)csd.uoc.gr together with your student ID no. using the subject line "HY475 Assign 1". Ask (and answer) questions via the [issue tracker](https://github.com/denniskb/hy475/issues).
